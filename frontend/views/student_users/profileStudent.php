    ...
    <div class="col-xl-4">
      <div class="card">
        ...
        <?php if ($ProfileData): ?>
            ...
            <h2><?= htmlspecialchars($ProfileData['student_name']) ?></h2>
            <h3><?= htmlspecialchars($ProfileData['student_section']) ?></h3>
        <?php else: ?>
          ...
          <div class="tab-content pt-2">
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-8 col-md-8"><?= $ProfileData['student_name']; ?></div>
              </div>

              <div class="row">
                <div class="col-lg-4 col-md-4 label"><i class="bi bi-envelope-at"></i> Email</div>
                <div class="col-lg-8 col-md-8"><?= $ProfileData['student_email']; ?></div>
              </div>
              
              <div class="row">
                <div class="col-lg-4 col-md-4 label"><i class="bi bi-journal-text"></i> Student ID</div>
                <div class="col-lg-8 col-md-8"><?= $ProfileData['student_no']; ?></div>
              </div>
